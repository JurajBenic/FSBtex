...
% moguce opcije su:
%	-> tip_rada: seminar, zavrsni, projekt, diplomski, zadatak, skripta
%	-> jezik (dodatni parametar, moze i bez njega ako se pise na hrvatskom): hrvatski, engleski
%	-> fancy -> opcija samo za skriptu da omoguci sliku kao pozadinu poglavlja
\documentclass[skripta]{FSBtex}
